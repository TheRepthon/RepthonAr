...
async def startup_process():
    ...
    logo = rf"""
{B_BLUE}╔───────────────────────────────────────╗
{B_BLUE}│ {C1}____  {C2}          {C3}_   {C4}_                 {B_BLUE}│
{B_BLUE}│{C1}|  _ \ {C2}___ _ __ {C3}| |_{C4}| |__   {C5}___  {C6}_ __  {B_BLUE}│
{B_BLUE}│{C1}| |_) {C2}/ _ \ '_ \{C3}| __|{C4} '_ \ {C5}/ _ \{C6}| '_ \ {B_BLUE}│
{B_BLUE}│{C1}|  _ <{C2}  __/ |_) {C3}| |_|{C4} | | |{C5} (_) {C6}| | | |{B_BLUE}│
{B_BLUE}│{C1}|_| \_{C2}\___| .__/ {C3}\__|_{C4}| |_|{C5}\___/{C6}|_| |_|{B_BLUE}│
{B_BLUE}│{C1}      {C2}    |_|   {C3}    {C4}     {C5}     {C6}     {B_BLUE}│
{B_BLUE}╚───────────────────────────────────────╝{RESET}"""

    done = f"""
{B_BLUE}╔───────────────────────────────────────╗
{B_BLUE}│ {G_GREEN}⌔ تـم تنصيـب ريبـــثون . . بنجـاح ✓       {B_BLUE}│
{B_BLUE}│ {G_GREEN}⌔ لـ إظهـار الاوامـر ارسـل ({cmdhr}الاوامر)         {B_BLUE}│
{B_BLUE}╚───────────────────────────────────────╝{RESET}"""
